...
- Live URL: https://referralarc.docsplainai.chatgpt.site — exact Sites version 9 is deployed, public without login, and verified through the full browser and native WebMCP paths
